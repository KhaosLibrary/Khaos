...
use Khaos\Console\Usage\Parser\Transition\ArgumentTransition;
use Khaos\Console\Usage\Parser\Transition\CommandTransition;
use Khaos\Console\Usage\Parser\Transition\LoopTransition;
...
class UsageParserBuilder
{
     ...
     * @throws Exception
     */
    public function createUsageParser($definition, OptionDefinitionRepository $definitionRepository = null)
    {
        $this->stack                      = [];
        $this->sequences                  = [];
        $this->sequence                   = [];
        $this->mode                       = self::MODE_REQUIRED;
        $this->globalDefinitionRepository = (!$definitionRepository) ? new OptionDefinitionRepository() : $definitionRepository;
        $this->usageDefinitionRepository  = new OptionDefinitionRepository();
